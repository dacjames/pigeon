...
func (c *current) onX5() (interface{}, error) {
	return "Z", nil
}

func (p *parser) callonX5() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onX5()
}

func (c *current) onX1(a interface{}) (interface{}, error) {
	return a, nil
}

func (p *parser) callonX1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
